...
public class ArrayUtils {
    ...
    */
     ...
     * @return Массив int[]
     */
    public static double[] createRandomDoubleArray(int length, double minValue, double maxValue) {
        double[] arr = new double[length];
        for (int i = 0; i < length; i++)
            arr[i] = Precision.round(minValue + RND.nextDouble()*(maxValue - minValue), 2);
        return arr;
    }

    /**
     * @see #createRandomDoubleArray(int, double, double)
     */
    public static double[] createRandomDoubleArray(int length, int maxValue) {
        return createRandomDoubleArray(length, 0, maxValue);
    }
     ...
     * @return Массив int[][]
     */
    public static double[][] createRandomIntMatrix(int rowCount, int colCount, int minValue, int maxValue) {
     ...
     */
    public static double[][] createRandomIntMatrix(int rowCount, int colCount, int maxValue) {
